...
public class FileNameComposer {
	...
	public static String composeSavedFileForAnotherSortName(
		...
		return composeDirectoryName(competitionDescriptor) + "-reserve"
				+ extension;
	}
	 ...
	 * @return le nom du fichier
	 */
	public static String composeWeighingPostFileName(
			final CompetitionDescriptor competitionDescriptor,
			final String weighingPost, final String extension) {
		return composeDirectoryName(competitionDescriptor) + "-poste"
				+ weighingPost + extension;
	}
	 ...
	 */
	public static String composeDirectoryName(
			final CompetitionDescriptor competitionDescriptor) {
		return (competitionDescriptor.getCategory() == CompetitionCategory.UNKNOWN_CATEGORY ? ""
				...
				+ competitionDescriptor.getCompetitionName().replaceAll(" ",
						"_")
				+ "-"
