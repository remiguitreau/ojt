	...
	public enum FFJDADatas {
		...
		CLUB {
			...
			public void completeCompetitorWithFFJDADatasLine(final Competitor competitor,
				...
				competitor.setClub(new Club(clubCode, OJTUtils.extractDepartmentFromClubId(clubCode), FFJDADatUtils.extractStringValue(datas[columnIndexes.clubNameIndex])));
			}
		},
		BIRTH_DATE {
			@Override
		...
		GRADE {
			@Override
			public void completeCompetitorWithFFJDADatasLine(Competitor competitor,
					String[] datas, FFJDADatColumnsIndexes columnIndexes) {
		...
		public abstract void completeCompetitorWithFFJDADatasLine(final Competitor competitor, final String[] datas, final FFJDADatColumnsIndexes columnIndexes);
	}
}
