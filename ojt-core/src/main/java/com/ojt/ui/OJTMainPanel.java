...
public class OJTMainPanel extends JPanel implements ConfigurationChangedListener {
    ...
    public void availableMenusChanged() {
        generateSourceFileButton.setVisible(OJTConfiguration.getInstance().getPropertyAsBoolean(
                OJTConfiguration.GENERATE_SOURCE_FILE_MENU));
        weighingButton.setVisible(OJTConfiguration.getInstance().getPropertyAsBoolean(
