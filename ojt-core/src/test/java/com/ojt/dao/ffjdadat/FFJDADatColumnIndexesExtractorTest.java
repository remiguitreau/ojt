...
public class FFJDADatColumnIndexesExtractorTest {
    ...
    @Test
    public void test_FFJDA_Dat_column_indexes_extraction_with_department_but_not_club_code() {
        final FFJDADatColumnsIndexes indexes = extractor.extractColumnIndexesFromLine("\"Nom\";\"Sexe\";\"Date de naissance\";\"Code Identifiant\";\"Adresse 1/2\";\"Adresse 2/2\";\"Code Postal\";\"Ville\";\"Désignation du Club\";\"Nom_club_complet\";\"Prénom\";\"Ceinture Noire\";\"DAN N°1\";\"DAN N°2\";\"Département\";\"DAN N°9\";\"DAN N°10\";".split(FFJDADatConstants.FIELDS_SEPARATOR_PATTERN));
        Assert.assertEquals(14, indexes.departmentIndex);
        Assert.assertEquals(-1, indexes.clubCodeIndex);
    }

    @Test
    public void test_FFJDA_Dat_column_indexes_extraction_with_Premon() {
        final FFJDADatColumnsIndexes indexes = extractor.extractColumnIndexesFromLine("\"Nom\";\"Sexe\";\"Date de naissance\";\"Code Identifiant\";\"Adresse 1/2\";\"Adresse 2/2\";\"Code Postal\";\"Ville\";\"Désignation du Club\";\"Nom_club_complet\";\"Prémon\";\"Ceinture Noire\";\"DAN N°1\";\"DAN N°2\";\"Département\";\"DAN N°9\";\"DAN N°10\";".split(FFJDADatConstants.FIELDS_SEPARATOR_PATTERN));
        Assert.assertEquals(10, indexes.firstNameIndex);
    }
}
